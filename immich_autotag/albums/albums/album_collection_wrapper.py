...
from immich_autotag.api.logging_proxy.albums.delete_album import logging_delete_album
...
class AlbumCollectionWrapper:
    ...
    def delete_album(
        ...
        report_entry = logging_delete_album(
            album_wrapper=wrapper, reason=reason, client=client
        )
        return report_entry
